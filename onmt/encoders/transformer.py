...
class TransformerEncoder(EncoderBase):
    ...
    def forward(self, src, lengths=None):
        ...
        # SMILES = myutils.recover_to_smiles(src, myutils.inver_vocab, myutils.invalid_words)
        #emb2 = myutils.gcn_emb(self.gcn, gs)

        #emb2 = emb2.view(src.size(1), -1, 21)   # emb2 is batch graph node embeddings, so it need unbatch.
